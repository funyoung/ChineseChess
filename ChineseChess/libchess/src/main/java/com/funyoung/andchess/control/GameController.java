...
//        pieces.put("bz4", new Piece("bz4", new int[]{3, 8}));
    ...
    private void addRedPieces(Map<String, Piece> pieces) {
    ...
    private void addBlackPieces(Map<String, Piece> pieces) {
    ...
    private void addPiece(Map<String, Piece> pieces, boolean red, char character, int index, int row, int col) {
